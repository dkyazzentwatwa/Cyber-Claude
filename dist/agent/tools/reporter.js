...
export class SecurityReporter {
    ...
    displaySummary(scanResult) {
        ...
        table.push([chalk.red.bold('Critical'), chalk.red(scanResult.summary.critical.toString())], [chalk.red('High'), chalk.red(scanResult.summary.high.toString())], [chalk.yellow('Medium'), chalk.yellow(scanResult.summary.medium.toString())], [chalk.green('Low'), chalk.green(scanResult.summary.low.toString())], [chalk.cyan('Info'), chalk.cyan(scanResult.summary.info.toString())], [chalk.white.bold('Total'), chalk.white.bold(scanResult.summary.total.toString())]);
     ...
     */
    exportJSON(scanResult, filename) {
        try {
     ...
     */
    exportMarkdown(scanResult, filename) {
        try {
     ...
     */
    createScanResult(findings, startTime) {
        const summary = {
