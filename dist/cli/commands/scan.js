        ...
        try {
            ...
            if (options.quick) {
                ...
                if (result.success) {
                    ...
                    if (options.nmap) {
                        ui.warning('Nmap MCP tool is not available - no working package found');
                    }
                    // Analyze with AI
                    ...
                    const analysisPrompt = 'Analyze these network connections for security concerns. Identify any suspicious connections, unusual ports, or potential security risks.';
