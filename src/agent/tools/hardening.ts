...
export class HardeningChecker {
   ...
   */
  async checkHardening(): Promise<ToolResult> {
    try {
  ...
  private async checkMacOSHardening(findings: SecurityFinding[]): Promise<void> {
    try {
  ...
  private async checkLinuxHardening(findings: SecurityFinding[]): Promise<void> {
    try {
  ...
  private async checkWindowsHardening(findings: SecurityFinding[]): Promise<void> {
    try {
  ...
  private async checkCommonHardening(findings: SecurityFinding[]): Promise<void> {
   ...
   */
  async getRecommendations(): Promise<ToolResult> {
    try {
      const osInfo = await si.osInfo();
